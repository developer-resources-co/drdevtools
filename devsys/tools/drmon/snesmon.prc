...
╨                   (C) 1991-1994 Developer Resources           ╨
...
Assembler Syntax
	...
	Note: Absolute Indirect and Absolute Indexed Indirect
	use pbr, not dbr
...
ASL	Shift Memory or Accumulator Left
  ...
  Direct Page (DP)            ASL dp        06     2   5(1,2)
  Absolute Indexed,X          ASL addr,X    1E     3   7(1)
  DP Indexed,X                ASL (dp,X)    16     2   6(1,2)
  ддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддд
...
BCC     Branch if Carry Clear
  ...
  Addressing Mode             Syntax      Opcode  # of  # of
					   (Hex) Bytes Cycles
  ддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддд
  Program Counter Relative    BCC nearlabel 90     2   2(1,2)
			  (or BLT nearlabel)
  ддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддд

  (1) Add 1 cycle if branch is taken
  (2) Add 1 cycle if branch taken crosses page coundary on
...
BCS     Branch if Carry Set
  ...
  Addressing Mode             Syntax      Opcode  # of  # of
					   (Hex) Bytes Cycles
  ддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддд
  Program Counter Relative    BCS nearlabel B0     2   2(1,2)
			  (or BGE nearlabel)
  ддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддд
...
BEQ	Branch if Equal
  ...
  Addressing Mode             Syntax      Opcode  # of  # of
					   (Hex) Bytes Cycles
  ддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддд
  Program Counter Relative    BCS nearlabel F0     2   2(1,2)
			  (or BGE nearlabel)
  ддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддд
...
BMI	Branch if Minus
  ...
  Addressing Mode             Syntax      Opcode  # of  # of
					   (Hex) Bytes Cycles
  ддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддд
  Program Counter Relative    BMI nearlabel 30     2   2(1,2)
  ддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддд
...
BNE	Branch if Not Equal
  ...
  Addressing Mode             Syntax      Opcode  # of  # of
					   (Hex) Bytes Cycles
  ддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддд
  Program Counter Relative    BNE nearlabel D0     2   2(1,2)
  ддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддд
...
BPL	Branch if Plus
  ...
  Addressing Mode             Syntax      Opcode  # of  # of
					   (Hex) Bytes Cycles
  ддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддд
  Program Counter Relative    BPL nearlabel 10     2   2(1,2)
  ддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддд
...
BRA	Branch Always
  ...
  Addressing Mode             Syntax      Opcode  # of  # of
					   (Hex) Bytes Cycles
  ддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддд
  Program Counter Relative    BRA nearlabel 80     2   2(1,2)
  ддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддд
...
BVC	Branch if Overflow Clear
  ...
  Addressing Mode             Syntax      Opcode  # of  # of
					   (Hex) Bytes Cycles
  ддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддд
  Program Counter Relative    BVS nearlabel 50     2   2(1,2)
  ддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддд
...
BVS	Branch if Overflow Set
  ...
  Addressing Mode             Syntax      Opcode  # of  # of
					   (Hex) Bytes Cycles
  ддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддд
  Program Counter Relative    BVS nearlabel 70     2   2(1,2)
  ддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддд
...
CMP	Compare Accumulator with Memory
  ...
  DP Indexed,X                CMP (dp,X)    C1     2   6(1,2)
  DP Indexed Indirect,X       CMP (dp),Y    D1     2   5(1,2,3)
  DP Indirect Indexed,Y       CMP [dp],Y    D7     2   6(1,2)
  DP Indirect Long Indexed,Y  CMP sr,S      C3     2   4(1)
  Stack Relative (SR)         CMP (sr,S),Y  C3     2   7(1)
  SR Indirect Indexed,Y
  ддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддд
...
CPX	Compare Index Register X with Memory
  ...
  Direct Page (DP)            CPX dp        E4     2   3(1,2)
  ддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддд
...
INC	Increment
  ...
  Absolute                    INC addr      CD     3   4(1)
  Direct Page (DP)            INC dp        C5     2   3(1,2)
  Absolute Indexed,X          INC addr,X    DD     3   4(1,3)
  DP Indexed,X                INC (dp,X)    C1     2   6(1,2)
  ддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддд
...
LDA	Load Accumulator from Memory
  ...
  DP Indexed,X                LDA dp,X      B5     2   4(1,2)
...
LDX	Load Index Register X from Memory
  ...
  Direct Page (DP)            LDX dp        A6     2   3(1,2)
  Absolute Indexed,X          LDX addr,X    BE     3   4(1,3)
  DP Indexed,Y                LDX (dp,X)    B6     2   6(1,2)
  ддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддд
...
LDY	Load Index Register Y from Memory
  ...
  Direct Page (DP)            LDY dp        A4     2   3(1,2)
  Absolute Indexed,X          LDY addr,X    BC     3   4(1,3)
  DP Indexed,Y                LDY (dp,X)    B4     2   6(1,2)
  ддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддд
...
STA	Store Accumulator to Memory
  ...
  Direct Page (DP)            STA dp        95     2   3(1,2)
  ...
  DP Indexed,X                STA dp,X      95     2   4(1,2)
...
STX	Store Index Register X to Memory
  ...
  Direct Page (DP)            STX dp        86     2   3(1,2)
...
STZ	Store Zero to Memory
  ...
  DP Indexed,X                STZ dp,X      74     2   4(1,2)
  ддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддд
