...
// 1 = reset asserted, 0 = normal		// SNES
...
//	DevelopmentSystemBoard( Port nBase = 0x304 );
	DevelopmentSystemBoard( Port nBase = 0x304, unsigned char far* slaveMem=(unsigned char far*)0xD0000000 );
	...
	ubyte wormhole( void )						{ return( wormhole_ ); }
...
private:
	...
	unsigned char far* slaveBuffer_;
