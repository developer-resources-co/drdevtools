...
- [ ] **Phase 1.5 — make it run**: real ncurses (or DAP) front end replacing the screen/
  input stubs so the linked binary launches instead of segfaulting.
...
- [x] 2026-06-10 — Phase 1: drmon compiles + links on Linux (SYSTEM=SNES) via Dockerized g++/CMake; 52 TUs → x86-64 ELF. Transport/screen/input stubbed (segfaults at runtime, by design). See [linux/README.md](devsys/tools/drmon/linux/README.md).
