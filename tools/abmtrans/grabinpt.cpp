...
void GetInput (int argc,char *argv[])
{
	...
	while ( argv[i] && *argv[i+1] == '-' )
		...
		cout <<
"TransABM " << szVersion << "  Copyright 1994 Cave Logic Studios.  All Rights Reserved.\n" <<
"Transition from one picture to another using an AnimBrush stencil\n" <<
...
"Usage: " << szProgName << " <LBM1> <LBM2> <stencilABM>\n";
//"Usage: " << szProgName << " <inputLBM1> <inputLBM2> <stencilABM>\n";
//        1         2         3         4         5         6         7			  8
