//==============================================================================
// bitshift.cpp: shift bytes sighed
// By Kevin T. Seghetti
...
main (int argc,char *argv[])
{
	...
	if(argc-argCount < 2)
        {
            printf ("\
BitShift V1.0  (c) 1992,93 Developer Resources.  All Rights Reserved.\n\
BitShift\n\
By Kevin T. Seghetti\n\
Format: BitShift [<switches>] <infile> <outfile>\n\
Switches:\n\
