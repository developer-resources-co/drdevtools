...
6. **VS Code source view** (needs live MAME + symbol file): set breakpoint in source view;
   continue; execution halts at the correct address; VS Code highlights the source line.
   **(Needs live MAME.)**
