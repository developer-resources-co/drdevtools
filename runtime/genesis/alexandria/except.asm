...
;------------------------------------------------------------------------------
	include	default.equ			; to get the debug switch
...
;code    segment ; changed to code segment by erk (9/9/92)
	...
	xref	ICD_BLK4
EXTABLE
	DC.L    Stack,ICD_BLK4,Buserr,Adderr       ; 00-0F / 00 » 03
	...
	DC.L    HBlankHandler,IRQ05,VBlankHandler,NMI           ; 70-7F / 28 » 31
...
;code    segment
	TSECTION	.text
	ifeq	DEBUG				; otherwise, labels are defined in debug file
Buserr
Adderr
Illegal
Diverr
