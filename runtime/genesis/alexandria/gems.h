/*
	...
	Change History:
	     3/17/93 added proper function prototypes
...
void gemsinit(const char *patchbankptr, const char *envbankptr, const char *seqbankptr, const char *sampbankptr);
...
/* stop all sequences */
void gemsstopall(void);

/* pause all active sequences */
void gemspauseall(void);

/* resume all paused sequences */
void gemsresumeall(void);
